...
async function fetchAccessToken() {
  ...
  // espacios/caracteres ocultos) + presencia del token OIDC (longitud, nunca
  // el valor). Útil para depurar el invalid_target del STS; quitar luego.
  console.log(`[seo/wif] STS audience=${JSON.stringify(audience)} · saEmail=${saEmail} · oidc=${oidc.length}c`);
