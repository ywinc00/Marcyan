...
const iaPymes: ClusterPage = {
  ...
  includes: {
    ...
    items: [
      ...
      { icon: 'lucide:bot', title: 'Aparece en ChatGPT y Gemini', desc: 'Preparamos tu información para que los asistentes de IA puedan encontrarte y recomendarte.' },
...
const precioSeoHouston: ClusterPage = {
  ...
  includes: {
    ...
    items: [
      ...
      { icon: 'lucide:bot', title: 'Listo para la IA (AEO)', desc: 'Tu información en un formato que ChatGPT y Gemini pueden leer y citar.' },
    ],
    tone: 'gold',
  },
  local: {
