  ...
  es: {
    ...
    services: {
      ...
      items: [
        ...
        { n: '04', icon: 'lucide:shopping-bag', title: 'E-commerce y tiendas', price: 'desde $900', href: '/es/houston/ecommerce',
        ...
        { n: '06', icon: 'lucide:palette', title: 'Branding e identidad', price: 'desde $150', href: '/es/houston/branding',
    ...
    contact: {
      ...
      form: {
        ...
        service: { label: 'Servicio de interés', ph: '¿Qué necesitas?', opts: ['Diseño web', 'Rediseño de sitio actual', 'E-commerce / Tienda en línea', 'IA conversacional / Chatbot', 'SEO local', 'SEO para IA (visibilidad en IA)', 'Branding e identidad', 'Mantenimiento continuo', 'Paquete completo'] },
        message: { label: 'Cuéntanos tu proyecto', ph: 'Describe brevemente lo que necesitas...' },
        submit: 'Enviar mensaje',
        sending: 'Enviando…',
        // Rótulo CORTO del botón completado. La frase larga vive abajo, en el
        // mensaje: meterla en el botón fue el bug que lo desbordaba.
        done: 'Recibido',
        success: 'Mensaje recibido.',
        successRef: 'Tu referencia:',
        successNext: 'Te respondemos en menos de 1 hora hábil.',
        successUrgent: '¿Es urgente? Llámanos al',
  ...
  en: {
    ...
    contact: {
      ...
      form: {
        ...
        successNext: 'We reply within 1 business hour.',
        successUrgent: 'Need it sooner? Call us at',
