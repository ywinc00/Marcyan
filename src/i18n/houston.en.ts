...
export const houstonHub = {
  meta: {
    ...
    description:
      'Bilingual web design studio in Houston: custom sites, conversational AI and local SEO. In true English and Spanish, with public pricing. Free proposal in 24h.',
  },
  path: '/en/houston',
  breadcrumb: [
    { name: 'Home', path: '/en/' },
  ...
  local: {
    ...
    paragraphs: [
      ...
      'We work the entire metro area as a service-area business, in true English and Spanish. <strong>We are not a remote agency that "also covers" Houston:</strong> we design, write and rank around how your customer actually searches here.',
    ],
    tone: 'gold' as const,
  },
  ...
  faq: {
    ...
    items: [
      { q: 'What services do you offer in Houston?', a: 'Custom web design and development, local SEO, conversational AI (assistants that respond 24/7), online stores, branding and maintenance. All bilingual in English and Spanish, built to reach the Spanish-speaking side of your Houston market. You can take a single service or a coordinated package.' },
      ...
      { q: 'Do you work in English and Spanish?', a: 'Yes. We are a bilingual studio. We design, write and rank in true English and Spanish, because in Houston your customers search in both languages.' },
      ...
      { q: 'Why a local bilingual studio and not a big agency?', a: 'Because we build your site in true English and Spanish, so you capture the Spanish-speaking side of your market, with public pricing and no forced contracts. We bring together something few offer as a package: web design, conversational AI and SEO, all bilingual and under one team.' },
    ] as FaqItem[],
  },
  // Final CTA: verb unified with the hero ("Request a free proposal") and the
