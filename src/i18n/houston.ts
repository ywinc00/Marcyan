...
export const houstonHub = {
  ...
  services: {
    ...
    links: [
      ...
      { label: 'IA conversacional en Houston', href: '/es/houston/ia-conversacional', desc: 'Asistentes que contestan y agendan 24/7. Desde $900.', icon: 'lucide:messages-square' },
