...
export const portfolioProjects: PortfolioProject[] = [
  {
    ...
    result: 'Ya posiciona en su zona de Houston, la IA de Google ya lo incluye en sus recomendaciones para algunas búsquedas y recibe visitas que llegan desde ChatGPT.',
  ...
  },
  {
    ...
    result: 'Ya posiciona en su zona de Orlando y la IA de Google ya lo incluye en recomendaciones para algunas búsquedas.',
...
export const portfolioPage = {
  ...
  faq: {
    ...
    items: [
      ...
      { q: '¿Publican métricas o números de resultados?', a: 'Solo decimos lo que podemos respaldar con honestidad: que reconstruimos sitios, montamos SEO local que ya posiciona y entregamos marcas y apps a medida. Hoy eso incluye algo nuevo: la IA de Google ya incluye a clientes nuestros en sus recomendaciones para algunas búsquedas, y uno de ellos ya recibe visitas que llegan desde ChatGPT. Cuando tengamos métricas con permiso del cliente, las publicaremos; mientras tanto, no inflamos porcentajes ni inventamos cifras.' },
