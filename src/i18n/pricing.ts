    ...
    links: [
      {
        ...
        desc: 'La respuesta directa, con el precio real y qué incluye.',
        icon: 'lucide:help-circle',
      },
      {
        label: 'Diseño web en Houston',
        href: '/es/houston/diseno-web',
        desc: 'El servicio a detalle, con proceso y proyectos reales.',
        icon: 'lucide:layout-template',
      },
      {
        label: 'IA para tu negocio',
        href: '/es/ia-para-pymes',
        desc: 'Asistentes y automatización en español, desde $900.',
        icon: 'lucide:bot',
      },
    ],
  },
