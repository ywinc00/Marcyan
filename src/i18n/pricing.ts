  ...
  },
  {
    ...
    tiers: [
      { key: 'aeoDiagnostic', name: 'Diagnóstico de Visibilidad en IA', value: null, display: tierDisplay(null), anchor: true,
        blurb: 'Revisamos si ChatGPT, Perplexity y Google pueden encontrarte y recomendarte. Sin costo ni compromiso.', href: '#contacto' },
      { key: 'aeoFoundations', name: 'Cimientos AEO', value: PRICE_ANCHORS.aeoFoundations, display: tierDisplay(PRICE_ANCHORS.aeoFoundations),
        blurb: 'Te preparamos para la IA: Bing Places, schema, FAQ y llms.txt para que los asistentes te lean y te citen.', href: '#contacto' },
      { key: 'aeoMonitoring', name: 'Monitoreo en IA', value: PRICE_ANCHORS.aeoMonitoring, monthly: true, display: tierDisplay(PRICE_ANCHORS.aeoMonitoring, true),
        blurb: 'Seguimiento mensual de cómo te ven y te mencionan los asistentes de IA, con ajustes continuos.', href: '#contacto' },
    ],
  },
  {
    id: 'ecommerce',
