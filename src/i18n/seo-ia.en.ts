...
export const aeoTiers: PriceService[] = [
  {
    ...
    includes: [
      ...
      'What you still need for AI to cite you',
...
export const seoIaPage = {
  ...
  hero: {
    ...
    sub: 'Your customers are already asking ChatGPT, Gemini and the AI in their WhatsApp for businesses like yours. We get AI to find you, understand you and recommend you, in English and Spanish. Start with a free diagnostic.',
  ...
  answer: {
    ...
    a: 'By preparing your information so AI can read it, understand it and cite you: Bing Places, structured data (schema), frequently asked questions and a consistent NAP. It pays to move now. According to the SOCi 2026 Local Visibility Index, ChatGPT recommends only 1.2% of local businesses. Whoever shows up wins the conversation.',
  ...
  distinction: {
    ...
    title: 'AI that <em>recommends</em> you ≠ AI that <em>serves</em> your customers',
    paragraphs: [
      ...
      'Your customers are already asking ChatGPT and Gemini (the AI that already appears in Google searches) "which mechanic, lawyer or restaurant do you recommend?". The question is simple: <strong>do you show up, or does your competition?</strong> SEO for AI (also called AEO or GEO) makes it you.',
    ],
    tone: 'teal' as const,
  },
  grid: {
  ...
  mechanics: {
    ...
    tone: 'teal' as const,
    items: [
      { icon: 'lucide:search', title: 'Bing Places (the data behind ChatGPT)', desc: 'ChatGPT queries Bing, not Google. We set up and optimize your Bing Places: the easy step almost no one takes.' },
      ...
      { icon: 'lucide:list-checks', title: 'Consistent NAP and directories', desc: 'Your name, address and phone identical everywhere: AI pulls much of its local data from there.' },
      ...
      { icon: 'lucide:line-chart', title: 'Measurement and adjustment', desc: 'We track how the assistants see and mention you, and we adjust. AI visibility is volatile: that is why it needs care month after month.' },
    ],
  },
  // Case #0 + done-for-you + bilingual wedge (Prose).
  caso0: {
    tag: 'Real cases',
    title: 'We apply it on <em>our own site</em> and on our <em>clients\' sites</em>',
    paragraphs: [
  ...
  faq: {
    ...
    items: [
      ...
      { q: 'How long until you see results?', a: 'It is hard to give an exact date, and be wary of anyone who promises one. As a reference, not a guarantee, the first signals usually take weeks, and a more solid presence takes several months. On top of that, AI answers change on their own: that is why it is ongoing work, not a switch you flip once.' },
  ...
  related: {
    ...
    links: [
      { label: 'Guide: how to show up in ChatGPT and Gemini', href: '/es/blog/como-aparecer-en-chatgpt-perplexity', desc: 'The step-by-step guide (in Spanish), if you prefer to understand the how in depth.', icon: 'lucide:book-open' },
