...
export const serviciosPage = {
  ...
  why: {
    ...
    items: [
      ...
      { icon: 'lucide:bot', title: 'Te encuentra la IA', desc: 'Construimos en HTML rápido que ChatGPT, Perplexity y Google sí pueden leer, para que aparezcas cuando preguntan por lo que ofreces.' },
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'Sí, sin costo ni compromiso. Revisamos si ChatGPT, Perplexity y Google pueden encontrarte y recomendarte, y te decimos con honestidad cómo estás. Si después quieres que trabajemos los cimientos o el monitoreo, esos sí tienen precio publicado; el diagnóstico no.',
      },
      {
