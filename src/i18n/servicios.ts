...
export const serviciosPage = {
  ...
  related: {
    ...
    links: [
      ...
      { label: 'SEO para IA en Houston', href: '/es/houston/seo-para-ia', desc: 'Que ChatGPT y Gemini te recomienden a ti. Diagnóstico gratis.', icon: 'lucide:bot' },
  ...
  why: {
    ...
    items: [
      ...
      { icon: 'lucide:bot', title: 'Te encuentra la IA', desc: 'Construimos en HTML rápido que ChatGPT, Gemini y Meta AI sí pueden leer, para que aparezcas cuando preguntan por lo que ofreces.' },
