...
export const sobreNosotros = {
  ...
  answer: {
    ...
    a: 'Marcyan Studio is a bilingual web design studio based in Houston, serving Miami: custom sites, AI assistants that serve your customers, and SEO, in true English and Spanish, with public pricing and verifiable work, so your business reaches both English- and Spanish-speaking customers.',
  },
  story: {
    tag: 'Who we are',
  ...
  values: {
    ...
    intro: 'It is not a single trick: it is a combination almost no one else puts together for the bilingual market.',
    items: [
      ...
      { icon: 'lucide:map-pin', title: 'Local and close', desc: 'Houston and Miami as a service-area business. You talk to us directly, no call center, in your language, with real context on your market.' },
    ],
    tone: 'gold' as const,
  } as SectionFeatures,
  founders: {
    ...
    paragraphs: [
      'When we open a new market or industry, we offer Founding Client spots: in exchange for trusting a young studio in that area, you get priority treatment, preferential terms and become one of our local case studies.',
  ...
  proof: {
    tag: 'Real work',
    title: 'Real businesses that <em>put their trust in us</em>',
    links: [
      { label: 'See the full portfolio', href: '/en/portfolio', desc: 'Texas Rush Remove, Move Junk Away, Julio\'s Landscape and Rosy Nails: live sites, SEO, branding and a live web app.', icon: 'lucide:folder' },
  ...
  faq: {
    ...
    items: [
      { q: 'Do you have an office in Houston or Miami?', a: 'We work as a service-area business: we cover Houston, Miami and their metro areas remotely and efficiently, without a public address. We handle the whole process, from proposal to delivery, online and in your language.' },
      ...
      { q: 'How are you different from other agencies?', a: 'In the combination: custom design, AI that truly makes you visible in search engines and assistants, truly bilingual sites with hreflang, public pricing and local presence. Plenty of agencies have one of these pieces; almost no one in the bilingual niche has them all.' },
